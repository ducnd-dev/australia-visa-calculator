  ...
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>Share links for clients; branded logo on share pages with Professional plan</li>
      ...
      <ol>
        <li>
          <Link href="/login">Create a practice account</Link> (free trial — no card required to explore).
        </li>
